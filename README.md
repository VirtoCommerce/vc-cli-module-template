...
```dos
dotnet new vc-module --ModuleName CustomerReviews --Author "Jon Doe" --CompanyName VirtoCommerce --PlatformVersion "3.200.0" --PlatformNuGetPackageVersion "3.200.0"
```
...
| --PlatformVersion (or -P) | Required Platform Version | string | Optional | 3.200.0 |
| --PlatformNuGetPackageVersion (or -Pl) | Required Platform NuGet Package Version | string | Optional | 3.200.0 |
